...
def singleImageRun(trainDuration, restTime, image, network, networkList, 
	...
	OUTPUT:
		...
		1) inputIntensity: updated value of the pixel"s intensity.
...
def runNetwork(network, networkList, trainDuration, countThreshold, inputIntensity,
	...
	INPUT:
		...
		19) constSums: numpy array. Parametric normailzation factor for
		the weights.
