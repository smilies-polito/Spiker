...
class Reg(VHDLblock):
	...
	def __init__(self, default_bitwidth = 8):
		...
		VHDLblock.__init__(self, entity_name = "reg")
		...
		self.entity.port.add("reg_in", "in", "std_logic_vector(N-1 downto 0)")
		
		# Output ports
		self.entity.port.add("reg_out", "out", "std_logic_vector(N-1 downto 0)")
