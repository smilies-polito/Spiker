...
from debug import debugNetwork


version = "../v0.1/"

if version not in sys.path:
	sys.path.insert(1, version)
...
while currentIndex < numberOfCycles:
	...
	inputIntensity, currentIndex, accuracies, spikesCounter, inputCounter =\
		singleImageTraining(
			trainDuration,
			restTime,
			dt,
	...
	debugNetwork(network, networkList, "excLayer", "exc2exc", "inh2exc",
			inputCounter, spikesCounter, trainDuration/dt,
			currentIndex, labelsArray[currentIndex])
