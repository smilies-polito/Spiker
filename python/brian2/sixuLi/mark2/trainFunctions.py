...
def singleImageTraining(image, networkList, network, trainDuration, restTime, 
	...
	inputIntensity, currentIndex, accuracies = train(
...
def train(networkList, network, trainDuration, spikesEvolution, 
		updateInterval, printInterval, currentSpikesCount, 
		prevSpikesCount, startTimeImage, startTimeTraining, accuracies, 
		labelsArray, assignements, inputIntensity, startInputIntensity, 
		currentIndex, mode):
