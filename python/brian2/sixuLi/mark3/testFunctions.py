...
def singleImageTest(trainDuration, restTime, image, network, networkList, 
		...
		assignements, startInputIntensity, mode, constSum):
...
def test(network, networkList, trainDuration, countThreshold, inputIntensity,
		currentIndex, spikesEvolution, updateInterval, printInterval,
		startTimeImage, startTimeTraining, accuracies, labelsArray,
		assignements, startInputIntensity, mode, currentSpikesCount,
		prevSpikesCount):
