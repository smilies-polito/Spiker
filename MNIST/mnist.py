...
#
#			1a) Data type. 
#			Data can be stored in various format into the file.  The
#			type of data is encoded in the second byte (starting the
#			count from the less significant byte of the magic
...
def idxBufferToArray(buffer):
	...
	# Four byte for the magic number, four byte for each dimension of the
	# data structure
	offset = 4*dataDim+4
